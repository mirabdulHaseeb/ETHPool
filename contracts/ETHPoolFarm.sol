...
import "./ETHPoolToken.sol";

contract ETHPoolFarm {
    ...
    string public name = "ETHPoolFarm";

    IERC20 public daiToken;
    ETHPoolToken public ethPoolToken;
    ...
    function withdrawYield() public {
        ...
        startTime[msg.sender] = block.timestamp;
        ethPoolToken.mint(msg.sender, toTransfer);
